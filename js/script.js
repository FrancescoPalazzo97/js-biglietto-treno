...
if (isNaN(myage) || isNaN(mykm)) { // Controllo che l'input sia un numero
...
else if (myage < 18) { // Se l'età è minore di 18
...
else if (myage >= 18 && myage<= 65){ // Se l'età è compresa tra 18 e 65
    ...
    alert(`Il costoo del biglietto è ${finalPrice.toFixed(2)}€`); // Stampo il prezzo finale tramite alert
}